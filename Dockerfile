...
# تثبيت Chromium، Geany، مدير الملفات، التيرمينال، خادم Nginx، والخطوط
...
# حقن شريط التحكم الاحترافي المتكامل
...
<div id="virtual-keyboard">
  <!-- سطر رفع وتنزيل الملفات والتمرير -->
  <div class="kbd-row">
...
# إعداد Supervisord المستقر بدون حلقة الكراش
